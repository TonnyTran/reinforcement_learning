...
book3 = open_workbook('../results/Dueling_DDQN_result_v1.2.1_7miners.xls')
book4 = open_workbook('../results/Dueling_DDQN_result_v1.2.1_9miners.xls')
...
plt.plot(X, Y1_average, 'r', label="3 miners", zorder=10)
plt.plot(X, Y2_average, 'b', label="5 miners", zorder=10)
plt.plot(X, Y3_average, 'y', label="7 miners", zorder=10)
plt.plot(X, Y4_average, 'g', label="9 miners", zorder=10)
plt.legend()
plt.show()